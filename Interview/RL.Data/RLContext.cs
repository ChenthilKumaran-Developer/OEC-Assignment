...
public class RLContext : DbContext
{
    ...
    public DbSet<UserAssignPlanProcedure> UserAssignPlanProcedure { get; set; }
    ...
    protected override async void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<UserAssignPlanProcedure>(typeBuilder =>
        {
            typeBuilder.HasKey(au => new { au.ProcedureId, au.UserId });           
            typeBuilder.Property(au => au.UserName).IsRequired();
        });

        //typeBuilder.HasOne(au => au.Procedure).WithMany().HasForeignKey(au => au.ProcedureId);
        //typeBuilder.HasOne(au => au.User).WithMany().HasForeignKey(au => au.UserId);
